...
class EnvironmentMapper
{
    ...
    protected static array $environmentVariables = [
        ...
        'SMPP_BIND_TYPE'                       => 'services.sms.providers.smpp.bind_type',
        'SMPP_ADDR_TON'                        => 'services.sms.providers.smpp.addr_ton',
        'SMPP_ADDR_NPI'                        => 'services.sms.providers.smpp.addr_npi',
        'SMPP_ADDRESS_RANGE'                   => 'services.sms.providers.smpp.address_range',
        'SMPP_SOURCE_ADDR_TON'                 => 'services.sms.providers.smpp.source_addr_ton',
        'SMPP_SOURCE_ADDR_NPI'                 => 'services.sms.providers.smpp.source_addr_npi',
        'SMPP_DEST_ADDR_TON'                   => 'services.sms.providers.smpp.dest_addr_ton',
        'SMPP_DEST_ADDR_NPI'                   => 'services.sms.providers.smpp.dest_addr_npi',
        'SMPP_REGISTERED_DELIVERY'             => 'services.sms.providers.smpp.registered_delivery',
        'SMPP_DATA_CODING'                     => 'services.sms.providers.smpp.data_coding',
        'SMPP_SERVICE_TYPE'                    => 'services.sms.providers.smpp.service_type',
