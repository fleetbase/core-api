...
class ChatParticipant extends FleetbaseResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'name'                               => $this->whenLoaded('user', $this->user ? $this->user->name : null),
            'username'                           => $this->whenLoaded('user', $this->user ? $this->user->username : null),
            'email'                              => $this->whenLoaded('user', $this->user ? $this->user->email : null),
            'phone'                              => $this->whenLoaded('user', $this->user ? $this->user->phone : null),
            'avatar_url'                         => $this->whenLoaded('user', $this->user ? $this->user->avatar_url : null),
